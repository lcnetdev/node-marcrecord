 ...
 * Writes record to the file (sync version).
 */
MarcIsoWriter.prototype.writeBuffer = function(record) {
  recordBuffer = bufferWrapper.allocUnsafe(100000);
  recordBuffer.fill(0);
  var recordBufferSize = MarcIsoWriter.recordToIso2709(record, recordBuffer, this.options);
  recordBuffer = recordBuffer.subarray(0, recordBufferSize);
  return recordBuffer;
};
