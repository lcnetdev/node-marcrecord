 ...
 * Opens records file by descriptor.
 */
MarcXmlReader.prototype.parseXMLtxt = function(xmltxt, options) {
    var self = this;
    this.readyToRead = true;
  
    this.parser = self.setParser();
  
    this.parser.write(xmltxt);
 ...
 * Set the parser.
 */
MarcXmlReader.prototype.setParser = function(options) {
  var self = this;
  this.position = 0;
